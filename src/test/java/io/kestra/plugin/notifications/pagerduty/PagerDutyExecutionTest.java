...
@KestraTest
public class PagerDutyExecutionTest extends AbstractNotificationTest {
    ...
    protected void init() throws IOException, URISyntaxException {
        repositoryLoader.load(Objects.requireNonNull(PagerDutyExecutionTest.class.getClassLoader().getResource("flows/common")));
        repositoryLoader.load(Objects.requireNonNull(PagerDutyExecutionTest.class.getClassLoader().getResource("flows/pagerduty")));
        this.runner.run();
    }
    ...
    void flow() throws Exception {
        ...
        assertThat(receivedData, containsString("{\"title\":\"Final task ID\",\"value\":\"failed\"}"));
        assertThat(receivedData, containsString("Kestra PagerDuty alert"));
    }
