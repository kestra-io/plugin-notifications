...
@KestraTest
public class ZendutyExecutionTest extends AbstractNotificationTest {
    ...
    protected void init() throws IOException, URISyntaxException {
        repositoryLoader.load(Objects.requireNonNull(ZendutyExecutionTest.class.getClassLoader().getResource("flows/common")));
        repositoryLoader.load(Objects.requireNonNull(ZendutyExecutionTest.class.getClassLoader().getResource("flows/zenduty")));
        this.runner.run();
    }
    ...
    void flow() throws Exception {
        ...
        assertThat(receivedData, containsString("changed status to FAILED"));
        assertThat(receivedData, containsString("\"Final task ID\":\"failed\""));
        assertThat(receivedData, containsString("Kestra Zenduty alert"));
    }
}
